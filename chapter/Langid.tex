...
The same experiment was also conducted with MLP classifiers (see \cite{kruspe_lid2}), but they generally performed worse than the SVM classifiers. In the case of the \textit{NIST2003LRE} data set, strong overtraining effects were observed.
