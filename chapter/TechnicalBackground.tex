...
\begin{equation}
\frac{\partial E}{\partial w_ij} = \frac{\partial E}{\partial y_j} \frac{\partial y_j}{\partial z_j} \frac{\partial z_j}{\partial w_ij}
\end{equation}
Then, the weights they are adjusted accordingly:
\begin{equation}
\Delta w_ij = - \ny \frac{\partial E}{\partial w_ij}
\end{equation}
where $\ny$ as the so-called learning rate which must be chosen carefully to ensure convergence of the training process.\\
