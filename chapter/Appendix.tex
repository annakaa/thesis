...
The following table displays the phrases performed in the \textit{AuthorRetrieval} data set. (The list does not add up to 90 entries because some phrases were repeated).
...
Been spending most their lives living in a gansta's paradise &  Gangsta's Paradise\\
...
Submission & Mean error & Median error & St. dev. error\\ \hline
