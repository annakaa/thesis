...
The employed phoneme set is based on ARPABET, and is also used in CMU Sphinx\footnote{\url{http://www.speech.cs.cmu.edu/cgi-bin/cmudict}} and in the \textit{TIMIT} annotations. It contains 39 phonemes. The listing in table \ref{tab:app_phonemes} taken from the Sphinx documentation:
	\footnotesize
