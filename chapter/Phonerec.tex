...
An overview of the approach is shown in figure \ref{fig:process_songify}. Five variants of the training part of \textit{TIMIT} are generated first. MFCC features are then extracted from these new data sets and used to train models.\\
...
\begin{table}
 ...
 \end{tabular}
\end{center}
 \caption{The five TIMIT variants that were used for training (rows are TIMIT blocks, columns are the five sub-datasets of the \textit{TIMIT} training corpus).
