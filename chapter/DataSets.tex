...
The phoneme annotations follow a model similar to ARPABET and contain 61 different phonemes \cite{Zue1990}. As described in \cite{timit_replacement}, the annotations are broken down to a set of 39 phonemes, which is commonly used in speech recognition, e.g. by CMU SPHINX. The phoneme set is listed in appendix \ref{app:phonemes})
%wo benutzt?
